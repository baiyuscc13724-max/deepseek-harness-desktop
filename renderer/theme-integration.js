(function exposeThemeIntegration(root) {
  ...
  function guestThemeBootstrap(createSettingsDialogCloser) {
    ...
    style.textContent = `
      ...
      [data-conversation-scroll] > [data-composer-seat] { position:sticky!important; z-index:18; bottom:0!important; box-sizing:border-box; flex:none!important; min-height:0!important; max-height:min(58dvh,520px); overflow-anchor:none; }
      [data-conversation-scroll] > [data-composer-seat] [data-composer-card="true"] { min-height:0!important; max-height:min(54dvh,480px); overflow:visible!important; }
      [data-conversation-scroll] > [data-composer-seat] [data-input-scroll="true"] { min-height:0!important; max-height:min(var(--dsh-composer-text-max-height,280px),40dvh)!important; overflow-y:auto; overscroll-behavior:contain; }
      [data-conversation-scroll] { scroll-padding-block-end:calc(var(--dsh-composer-height,152px) + 60px); }
      [data-conversation-scroll] div:has(> button:is([aria-label="回到底部"],[aria-label="Back to bottom"])) { display:flex!important; position:sticky!important; z-index:19!important; bottom:calc(var(--dsh-composer-height,152px) + max(8px,env(safe-area-inset-bottom)))!important; justify-content:center; align-items:center; overflow:visible; pointer-events:none; }
      [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]) { display:inline-flex!important; box-sizing:border-box!important; inline-size:44px!important; block-size:44px!important; min-inline-size:44px; min-block-size:44px; align-items:center; justify-content:center; margin:0; border:1px solid var(--dsw-alias-border-l2); border-radius:999px; padding:0; color:var(--dsw-alias-label-primary); background:color-mix(in srgb,var(--dsw-alias-bg-layer-1) 92%,var(--dsw-alias-brand-primary) 8%); box-shadow:var(--dsw-elevation-soft); opacity:1; visibility:visible; pointer-events:auto; cursor:pointer; touch-action:manipulation; scroll-margin-block-end:calc(var(--dsh-composer-height,152px) + 12px); transition:transform .14s ease,background-color .14s ease,border-color .14s ease,box-shadow .14s ease; }
      @media (hover:hover) { [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):hover { border-color:var(--dsw-alias-brand-primary); background:var(--dsw-alias-interactive-bg-hover); transform:translateY(-1px); } }
      [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):active { border-color:var(--dsw-alias-brand-primary); background:var(--dsw-alias-interactive-bg-active); transform:translateY(1px) scale(.98); }
      [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):focus-visible { outline:3px solid var(--dsw-alias-brand-primary)!important; outline-offset:2px; box-shadow:0 0 0 2px var(--dsw-alias-bg-base),var(--dsw-elevation-soft); }
      html[data-hd-reduced-motion="true"] [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]) { transition:none!important; }
      html[data-hd-reduced-motion="true"] [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):hover,html[data-hd-reduced-motion="true"] [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):active { transform:none!important; }
      @media (prefers-reduced-motion:reduce) { [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]) { transition:none!important; } [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):hover,[data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]):active { transform:none!important; } }
      @media (forced-colors:active) { [data-conversation-scroll] button:is([aria-label="回到底部"],[aria-label="Back to bottom"]) { border-color:ButtonText; color:ButtonText; background:Canvas; forced-color-adjust:auto; } }
