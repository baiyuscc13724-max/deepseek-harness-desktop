(function exposeThemeIntegration(root) {
  ...
  function guestThemeBootstrap(createSettingsDialogCloser) {
    ...
    style.textContent = `
      ...
      [data-conversation-scroll] div:has(> button[aria-label="回到底部"]),[data-conversation-scroll] div:has(> button[aria-label="Back to bottom"]),[data-conversation-scroll] button[aria-label="回到底部"],[data-conversation-scroll] button[aria-label="Back to bottom"] { display:none!important; }
