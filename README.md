...
下一发布候选：**v1.0.61** · 上一稳定版：**v1.0.60** · [查看候选更新内容](release-notes.md)

> 候选 `v1.0.61` 维持官方 Harness `0.1.2-alpha.5` 依赖，合入 PR #47 的安全运行时端口与团队加载修复，以及手机重连、清单鉴权、关闭收敛、恢复和附件交互修复。不纳入维护树其他浏览器、离屏或原生预览改动；已发布版本的 Tag 与资产不移动、不覆盖。
>
> `v1.0.61` 尚未发布，也尚未进入 stable feed。下表继续提供不可变的 `v1.0.60` 稳定资产；本轮不追加测试或现场复现，现有发布器内置门禁、正式云构建/签名与双云核对仍须完成。完成前请以[永久最新版下载页](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/latest)为准。
>
> 此前的官方 `0.1.2-alpha.4` 与更早版本仅保留为可复核的历史迁移基线，不再描述当前候选运行时。

| 版本 | 适合谁 | 下载 |
| --- | --- | --- |
| Windows 中文安装版 | 日常使用；会创建快捷方式并保留原安装位置 | [下载安装包](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Desktop-1.0.60-win-x64.exe) |
| Windows 便携版 | 不想安装；下载后直接运行 | [下载便携版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Desktop-1.0.60-portable-x64.exe) |
| macOS Apple Silicon | M1/M2/M3/M4 系列 Mac | [下载 DMG](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Desktop-1.0.60-mac-arm64.dmg) |
| macOS Intel | Intel 处理器 Mac | [下载 DMG](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Desktop-1.0.60-mac-x64.dmg) |
| Android 手机端 1.0.60 | 扫码配对、四域工作台、原生输入、受限文档上传与固定手机控制 | [下载签名 APK](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Mobile-1.0.60-android-universal.apk) · [SHA-256](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/Harness-Mobile-1.0.60-android-universal.apk.sha256) |
| SHA-256 校验文件 | 手动核对本次桌面安装包完整性 | [下载校验文件](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.60/SHA256SUMS.txt) |
