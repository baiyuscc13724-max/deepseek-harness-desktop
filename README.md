...
- [Windows 中文安装版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.5/Harness-Desktop-1.0.5-win-x64.exe)
- [Windows 便携版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.5/Harness-Desktop-1.0.5-portable-x64.exe)
- [SHA-256 校验文件](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.5/SHA256SUMS.txt)
