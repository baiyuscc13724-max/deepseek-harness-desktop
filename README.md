...
- [Windows 中文安装版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v0.9.0-rc.9/Harness-Desktop-0.9.0-rc.9-win-x64.exe)
- [Windows 便携版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v0.9.0-rc.9/Harness-Desktop-0.9.0-rc.9-portable-x64.exe)
- [SHA-256 校验文件](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v0.9.0-rc.9/SHA256SUMS.txt)
