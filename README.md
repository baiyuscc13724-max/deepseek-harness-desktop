...
| Windows 便携版 | 不想安装；下载后直接运行 | [下载便携版](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.19/Harness-Desktop-1.0.19-portable-x64.exe) |
| Android 手机端（测试版） | 与桌面端扫码配对、同步会话并授权固定手机操作 | [下载 APK](https://github.com/baiyuscc13724-max/deepseek-harness-desktop/releases/download/v1.0.19/Harness-Mobile-1.0.19-android-universal-beta.apk) |
