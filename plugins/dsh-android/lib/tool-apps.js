...
import { buildRun, detectProject, launchPackage, } from './build-run.js';
import { filterAndroidApps, listAndroidApps, noMatchCandidateLines, noMatchListingHint, resolveAppByName, } from './app-list.js';
import { appSchema, deviceSchema, errorMessage, renderJson, resolveTarget, } from './tool-support.js';
/** Create the app-lifecycle tools bound to one host controller. */
export function createAndroidAppTools(host) {
