...
export declare const ANDROID_FRAME_STYLE_BEZEL: AndroidFrameStyle;
/** The control's option roster (无框 / 边框 / 手机框 order). */
export declare const ANDROID_FRAME_STYLE_OPTIONS: readonly AndroidFrameStyle[];
/** Defensive parse of a frame-style id; unknown ids fall back to bezel. */
export declare function androidFrameStyleOf(id: string): AndroidFrameStyle;
/** User-facing label for one frame style (copy lives in copy.ts). */
export declare function androidFrameStyleLabelOf(style: AndroidFrameStyle, copy: AndroidCopy): string;
/** Slim bezel shell thickness on every side. */
export declare const ANDROID_FRAME_BEZEL_SHELL = 6;
/** Device shell thickness on every side. */
export declare const ANDROID_FRAME_DEVICE_SHELL = 16;
/**
 ...
 */
export declare const ANDROID_FRAME_SHELL_BORDER_PX = 1;
/**
 ...
 */
export declare const ANDROID_FRAME_SCREEN_RADIUS_RATIO: number;
/**
 ...
 */
export declare const ANDROID_FRAME_RADIUS_FALLBACK_PX = 30;
/** Shell padding per mode: none → 0, bezel → 6, device → 16. */
export declare function androidPanelShellPadOf(style: AndroidFrameStyle): number;
/** Shell border thickness per mode: none → 0, bezel → 1, device → 1. */
export declare function androidPanelFrameBorderPxOf(style: AndroidFrameStyle): number;
/**
 ...
 * bezel → 7, device → 17.
 */
export declare function androidPanelFrameInsetOf(style: AndroidFrameStyle): number;
/**
 ...
 */
export declare function androidPanelScreenWidthOf(frameWidthCss: number, frameStyle: AndroidFrameStyle): number;
/**
 ...
 */
export declare function androidPanelScreenRadiusOf(displayedW: number, displayedH: number): number;
/**
 * Concentric shell outer radius: screen radius + shell pad (none → +0, so the
 * frameless "shell" radius IS the screen's clip radius).
 */
export declare function androidPanelShellRadiusOf(style: AndroidFrameStyle, screenRadius: number): number;
/**
 ...
 */
export declare function androidPanelScreenBoxOf(mode: AndroidPanelSizeMode, naturalWidth: number | undefined, naturalHeight: number | undefined, frameStyle: AndroidFrameStyle): {
    width: number;
    height: number;
} | undefined;
/**
 ...
 */
export declare function androidPanelFrameRadiusFallbackOf(naturalWidth: number | undefined, naturalHeight: number | undefined): number;
