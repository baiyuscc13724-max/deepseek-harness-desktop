...
export function mediaFrameStyles(_colorScheme) {
    return {
        maxHeight: 420,
        overflow: 'hidden',
        borderRadius: 8,
 ...
 */
export const PANEL_STREAM_STAGE_STYLES = {
    display: 'flex',
    flexDirection: 'column',
    width: '100%',
    height: '100%',
 ...
 */
export const PANEL_STREAM_BOX_STYLES = {
    position: 'relative',
    width: '100%',
    flex: 'none',
    touchAction: 'none',
 ...
 */
export const PANEL_STREAM_IMG_STYLES = {
    position: 'absolute',
    inset: 0,
    width: '100%',
    height: '100%',
 ...
 */
export const PANEL_SCREENSHOT_IMAGE_STYLES = {
    display: 'block',
    width: '100%',
    height: '100%',
    objectFit: 'contain',
...
export const PANEL_LOADING_STYLES = {
    flex: 1,
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
...
export const PANEL_FALLBACK_STYLES = {
    flex: 1,
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
