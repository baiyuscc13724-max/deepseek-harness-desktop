 ...
 */
import { androidDeviceScaleOf, androidPanelFrameLayoutOf, androidPanelFrameWidthOf, androidPanelSnapPxOf, } from './android-panel-size.js';
/** Shared default (stable identity — the store and panels all use it). */
export const ANDROID_FRAME_STYLE_BEZEL = 'bezel';
/** The control's option roster (无框 / 边框 / 手机框 order). */
export const ANDROID_FRAME_STYLE_OPTIONS = ['none', 'bezel', 'device'];
/** Defensive parse of a frame-style id; unknown ids fall back to bezel. */
export function androidFrameStyleOf(id) {
...
export function androidFrameStyleLabelOf(style, copy) {
    switch (style) {
...
export function androidPanelShellPadOf(style) {
    switch (style) {
        case 'none': return 0;
...
export function androidPanelFrameBorderPxOf(style) {
 ...
 * bezel → 7, device → 17.
 */
export function androidPanelFrameInsetOf(style) {
 ...
 */
export function androidPanelScreenWidthOf(frameWidthCss, frameStyle) {
 ...
 */
export function androidPanelScreenRadiusOf(displayedW, displayedH) {
 ...
 */
export function androidPanelShellRadiusOf(style, screenRadius) {
 ...
 */
export function androidPanelScreenBoxOf(mode, naturalWidth, naturalHeight, frameStyle) {
 ...
 */
export function androidPanelFrameRadiusFallbackOf(naturalWidth, naturalHeight) {
    const layout = androidPanelFrameLayoutOf(naturalWidth, naturalHeight);
