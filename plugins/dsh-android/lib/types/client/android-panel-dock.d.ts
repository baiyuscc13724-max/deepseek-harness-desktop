 ...
 */
export declare const ANDROID_PANEL_DOCK_ATTRIBUTE = "dshAndroidPanelDockOwner";
 ...
 */
export declare const ANDROID_DOCK_MAX_FOREIGN_FRACTION = 0.6;
/**
 ...
 */
export declare function claimAndroidPanelDock(root: HTMLElement, owner: string, initialWidth: number, computedMarginRight?: number, viewportWidth?: number): AndroidPanelDockLease | undefined;
