window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    Object.assign(zh, {
      ...
      planLifecycleTitle: "计划生命周期", planLifecycleHint: "阶段、授权和交接均来自 Host 持久记录；未完成或未知的事实不会被推测。", planDraft: "草案", planCommitted: "已提交", planActive: "已激活", planRevision: "计划修订 {value}", planPauseEpoch: "暂停代次 {value}", planAuthorization: "计划预检", planAuthorizationSource: "授权依据：{value}", planAuthHostVerified: "Host 已验证", planAuthHumanAttested: "用户已确认（未获 Host 证明）", planAuthUnknown: "尚未验证", planPreflightPermissions: "权限", planPreflightFiles: "文件边界", planPreflightCost: "模型成本", planPreflightEffects: "外部副作用", planLegacyUnplanned: "这是迁移保留的旧团队，尚无完整计划记录。", planLegacyActiveGate: "旧团队的进行中工作已保留；新认领和新成员仍受当前计划门禁约束。", handoffTitle: "负责人交接", handoffNone: "当前没有待接管的交接。", handoffPending: "交接已准备，正在等待目标负责人接管。", handoffPreparedAt: "准备于 {value}", handoffExpiresAt: "有效期至 {value}", handoffHistory: "最近交接记录", handoffPrepared: "已准备交接", handoffAdopted: "已完成接管", handoffHistoryMore: "仅显示最近 {count} 条安全记录。",
      ...
      return h("section", { className: "dat-panel dat-plan-lifecycle", role: "region", "aria-labelledby": "dat-plan-lifecycle-title" },
        ...
        h("div", { className: "dat-plan-grid" },
          h("section", { className: "dat-plan-subsection", "aria-labelledby": "dat-plan-preflight-title" },
            ...
            h("div", { className: "dat-preflight-grid" }, preflight.map(function (item) { return h("div", { key: item.key, className: "dat-preflight-item" }, h("span", null, item.label), h("span", { className: "dat-status-chip", "data-status": item.status }, planAuthorizationLabel(t, item.status))); }))
          ),
