...
test('model settings keep account meters below routing and reserve tabs for routing and credentials', () => {
  ...
  assert.doesNotMatch(source, /data-hd-model-view="meters"/)
  assert.match(source, /class="hd-route-shell"/)
  assert.match(source, /class="hd-meter-section"/)
  assert.ok(source.indexOf('<div class="hd-route-footer"') < source.indexOf('<section class="hd-meter-section"'))
  ...
  assert.match(source, /panel\.hidden = activeView !== 'routing'/)
  assert.match(source, /element\.dataset\.hdModelNativeHidden = String\(activeView !== 'credentials'\)/)
...
test('desktop model settings keep routing, subagent and quota controls visible in the Models section', () => {
  ...
  assert.doesNotMatch(integration, /data-hd-model-view="meters"/)
  assert.match(integration, /class="hd-meter-section"/)
