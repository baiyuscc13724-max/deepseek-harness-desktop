...
test('checked-in Android mobile version has the unified 1.0.54 release identity', () => {
  const version = readAndroidMobileVersion(root)
  assert.deepEqual(version, {
    integrationVersion: '1.0.54',
    versionName: '1.0.54',
    versionCode: 1_005_400,
    tag: 'android-v1.0.54',
    assetName: 'Harness-Mobile-1.0.54-android-universal.apk',
    checksumName: 'Harness-Mobile-1.0.54-android-universal.apk.sha256'
  })
})
