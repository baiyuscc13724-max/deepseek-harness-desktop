...
test('checked-in Android mobile version has the unified 1.0.53 release identity', () => {
  const version = readAndroidMobileVersion(root)
  assert.deepEqual(version, {
    integrationVersion: '1.0.53',
    versionName: '1.0.53',
    versionCode: 1_005_300,
    tag: 'android-v1.0.53',
    assetName: 'Harness-Mobile-1.0.53-android-universal.apk',
    checksumName: 'Harness-Mobile-1.0.53-android-universal.apk.sha256'
  })
})
