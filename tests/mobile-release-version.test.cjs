...
test('checked-in Android mobile version has the unified 1.0.61 release identity', () => {
  const version = readAndroidMobileVersion(root)
  assert.deepEqual(version, {
    integrationVersion: '1.0.61',
    versionName: '1.0.61',
    versionCode: 1_006_100,
    tag: 'android-v1.0.61',
    assetName: 'Harness-Mobile-1.0.61-android-universal.apk',
    checksumName: 'Harness-Mobile-1.0.61-android-universal.apk.sha256'
  })
})
