...
const PLUGIN_ID = 'desktop-directory-picker'
const PLUGIN_PACKAGE = 'dsh-desktop-directory-picker'
...
async function ensureDesktopDirectoryPickerPlugin({ dshHome, bundledRoot }) {
  ...
  if (sourcePackage.name !== PLUGIN_PACKAGE) throw new Error('内置桌面工作区选择插件包无效。')
...
module.exports = { PLUGIN_ID, PLUGIN_PACKAGE, ensureDesktopDirectoryPickerPlugin, ensurePatchEntry }
