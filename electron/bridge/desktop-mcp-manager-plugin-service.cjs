...
const PLUGIN_ID = 'desktop-mcp-manager'
const PLUGIN_PACKAGE = 'dsh-desktop-mcp-manager'
...
async function ensureDesktopMcpManagerPlugin({ dshHome, bundledRoot }) {
  ...
  if (manifest.name !== PLUGIN_PACKAGE) throw new Error('内置 MCP 管理器插件包无效。')
...
module.exports = { PLUGIN_ID, PLUGIN_PACKAGE, ensureDesktopMcpManagerPlugin, ensurePatchEntry }
