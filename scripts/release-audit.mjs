...
if (pkg.version !== '1.0.28') throw new Error(`release audit expects 1.0.28, got ${pkg.version}`)
...
for (const contract of ['component-publish/v1.0.28', 'HARNESS_COMPONENT_SIGNING_PRIVATE_KEY_BASE64', 'base64 --decode', "trap 'rm -f", 'prepare-production-components.mjs', 'verify-production-component-staging.mjs', 'Refuse replacement or partial component publication', 'gh release upload', 'Re-download and verify public component assets']) {
...
for (const contract of ['verify-component-signing-secret/v1.0.28', 'HARNESS_COMPONENT_SIGNING_PRIVATE_KEY_BASE64', 'base64 --decode', "trap 'rm -f", 'verify-component-signing-key.mjs']) {
