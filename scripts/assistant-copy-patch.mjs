...
const COMPONENT_PATCH = `\t\tfunction AssistantCopyButton({ text, t }) {
...
\t\t\t\ttitle: label,
\t\t\t\tonClick: onCopy,
\t\t\t\tchildren: [copied ? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, {}) : (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCopyOutline16, {}), (0, react_jsx_runtime.jsx)("span", { className: "hd-assistant-copy-label", "aria-live": "polite", children: label })]
\t\t\t});
\t\t}
...
export function patchAssistantCopySource(source) {
  if (source.includes(PATCH_MARKER)) {
    for (const required of ['function AssistantCopyButton', 'className: "hd-assistant-copy-dock"', 'writeClipboard)(text)', 'copyText: owner === void 0 ? "" : assistantText(tail.closing.blocks)', 't("message.copyResponse")', '"message.copiedResponse": "全文已复制"', '"message.copiedResponse": "Full response copied"']) {
