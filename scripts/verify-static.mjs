...
const required = [
  ...
  'docs/ARCHITECTURE.zh-CN.md', 'docs/COMPETITOR-FEATURE-BENCHMARK.zh-CN.md', 'docs/UPDATE-MIRRORS.zh-CN.md', 'docs/COMPONENT-UPDATES.zh-CN.md', 'docs/CROSS-PLATFORM-MOBILE.zh-CN.md', 'docs/mobile-app-updates.md', 'docs/BRANDING.zh-CN.md', 'docs/VALIDATION.zh-CN.md', 'docs/CLOUD-RELEASE-PIPELINE.zh-CN.md', 'docs/SECURITY-REVIEW-v1.0.45.zh-CN.md', 'docs/assets/harness-desktop-hero.jpg',
