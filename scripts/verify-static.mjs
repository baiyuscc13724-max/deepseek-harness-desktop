...
const required = [
  ...
  'electron/bridge/capability-broker.cjs', 'electron/bridge/computer-use-screenshot-store.cjs', 'electron/bridge/storage-scan-service.cjs', 'electron/bridge/storage-cleanup-service.cjs', 'electron/bridge/storage-management-service.cjs', 'electron/bridge/memory-censor.cjs', 'electron/bridge/memory-service.cjs', 'electron/bridge/browser-url-policy.cjs', 'electron/bridge/browser-session-policy.cjs', 'electron/bridge/browser-site-authz.cjs', 'electron/bridge/browser-action-gate.cjs', 'electron/bridge/browser-audit.cjs', 'electron/bridge/browser-security-policy.cjs', 'electron/bridge/browser-control-server.cjs',
...
for (const contract of ['workflow_dispatch:', 'runs-on: macos-14', 'Select Xcode 16', 'xcodegen generate', 'iPhone Simulator', 'iPad Simulator', 'xcodebuild test', 'Build unsigned Intel app bundle', 'Build unsigned Apple Silicon app bundle', '--cpu=x64', '--cpu=arm64', 'CODE_SIGNING_ALLOWED=NO']) {
