# Harness Desktop v0.9.0-rc.6 验收
...
7. 在“设置 → 外观皮肤”双击不同卡片，确认主题立即显示且设置弹窗保持居中；
8. 重启桌面版并升级 Harness 核心后，确认已选主题和自定义配置仍保留；
9. 完成一个真实模型请求和一次需要 Harness 权限的操作；
10. 退出后确认没有残留由桌面版创建的 Runtime 进程。
